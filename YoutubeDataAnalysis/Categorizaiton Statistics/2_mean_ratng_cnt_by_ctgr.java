...
import org.apache.hadoop.mapreduce.lib.output.TextOutputFormat;
   ...
   public class App extends Configured implements Tool{
    ...
    public static class Map5 extends Mapper<LongWritable, Text, Text,
    IntWritable> {
    ...
    throws IOException, InterruptedException {
              ...
              if(str.length > 5){
		            	   bal.set(Integer.parseInt(str[7]));
    ...
    public static class Reduce5 extends Reducer<Text, IntWritable,
    Text, IntWritable> {
    ...
    Context context)
             throws IOException, InterruptedException {
               ...
               System.out.println( "Key="+ key + ", " +  "Sum=  " +  sum +", " + "Rating Count Frequencies by Category = " + count2 +", " + "average=  " +  average);
               System.out.println();
